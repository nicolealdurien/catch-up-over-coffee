let exercises = [
  ...
  },
  {
    ...
    description:
      "To come into Cow pose, start from all fours in a tabletop position. Your knees under your hips and wrists under your shoulders or slightly forwards of them Spread your fingers, root down through the base of the fingers and press your fingers on the mat. Spread your fingers, root down through the base of the fingers and press your fingers on the mat. On an inhalation, lower the belly, lift your chest, tailbone pointing up and look up. Exhale, come back into your neutral ‘tabletop’ position.",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    description:
      "Start to wriggle your fingers and toes. With your eyes closed, draw your knees in and slowly roll over to your left or right side. Rest there for a moment and with an inhale, find a comfortable seated position. Take the peace and stillness found in this pose with you for the rest of your day.",
  },
  {
    id: 12,
    ...
    description:
      "From Downward-Facing Dog, step the right foot between the hands by the right thumb. Stay on the ball of the back foot, stacking the right heel over the ball of the right foot, and raise the upper body toward the ceiling. Stack the shoulders over the hips with the right knee at a 90 degree angle.",
  },
  {
    id: 13,
  ...
  },
  {
    ...
    description:
      "Begin on your hands and knees. Place your forearms on the floor parallel to each other, palms down. Your elbows should be directly beneath your shoulders, knees right under your hips. Actively press your hands and forearms into the floor. Curl your toes under then straighten your legs as if coming into Downward Facing Dog Pose. If fully straightening your legs causes your back to round, keep the legs at least slightly bent. Lift your sitting bones up toward the sky as you lengthen your spine through the tailbone. Extend down through your heels and keep your shoulder blades firmed against your back.Don’t rest your head on the floor, which will tempt you to use it as support, or allow it to hang freely. Instead, hold your head between your upper arms in direction with the V-shape of the pose. Breathe deep and slow in Dolphin Pose for 3-8 breaths, then release your knees back to the floor.",
  },
  {
    id: 15,
  ...
  },
  {
    ...
    description:
      "Start in Adho Mukha Svanasana / Downward Facing Dog. As you exhale, step your right foot forward, between your hands. Lower your left knee to the floor, sliding the foot back until you feel a nice stretch in the left hip and thigh. Keep the hips low and level with each other.",
  },
  {
    id: 24,
  ...
  },
  {
    ...
    description:
      "Bend your right knee, then rotate it outward from the hip. Roll your left thigh open and, while supporting your right ankle with your hands, begin to draw your right ankle into your groin. Keep your left leg rotated open and bend your left knee, bringing your heel in toward your navel.",
  },
  {
    id: 32,
    ...
    description:
      "Keeping your left leg in its current position, place your right foot to the outside of your left knee. Root down with your right big toe mound while simultaneously descending your right outer hip. Inhale, and take your left arm to the ceiling. Exhale, and hook your left elbow to the outside of your right knee.",
  },
  {
    id: 33,
