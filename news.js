...
function getNews() {
fetch('http://api.mediastack.com/v1/news?access_key=369b8d9662e87a57ee008cecd6aae010&languages=en')
    .then(response => {
...
btnSearchSource.addEventListener("click", function() {
    ...
    fetch(`http://api.mediastack.com/v1/news?access_key=369b8d9662e87a57ee008cecd6aae010&languages=en&sources=${searchSource}`)
    .then(response => {
        return response.json()
    }).then(result => {
        removeDupes(result)        
...
btnSearchKeyword.addEventListener("click", function() {
    ...
    fetch(`http://api.mediastack.com/v1/news?access_key=369b8d9662e87a57ee008cecd6aae010&languages=en&keywords=${searchKeyword}`)
    .then(response => {
        return response.json()
    }).then(result => {
        removeDupes(result)     
...
dropdownSelectCategory.addEventListener("change", function () {
  ...
  fetch(`http://api.mediastack.com/v1/news?access_key=369b8d9662e87a57ee008cecd6aae010&languages=en&categories=${passCategoryToFetch}`)
  .then(response => {
      return response.json()
  }).then(result => {
      removeDupes(result)         
